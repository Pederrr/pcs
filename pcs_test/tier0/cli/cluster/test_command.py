...
class NodeRemoveRemoteBase:
    def setUp(self):
        ...
        self.lib.remote_node = mock.Mock(
            spec_set=[
                "get_resource_ids_from_remote_node_identifier",
                "node_remove_remote",
            ]
        )
    ...
    def test_too_many_args(self, mock_process_library_reports):
        ...
        self.assertIsNone(cm.exception.message)
        self.remote_node.node_remove_remote.assert_not_called()
        self.remote_node.get_resource_ids_from_remote_node_identifier.assert_not_called()
        self.resource.stop.assert_not_called()
        self.cluster.wait_for_pcmk_idle.assert_not_called()
        self.report_processor.assert_not_called()
        self.report_processor.reports.assert_not_called()
    ...
    def test_remove_not_stopped(self, mock_process_library_reports):
        ...
        self.remote_node.get_resource_ids_from_remote_node_identifier.return_value = [
            "A"
        ]
        ...
        self.remote_node.get_resource_ids_from_remote_node_identifier.assert_called_once_with(
            "A"
        )
