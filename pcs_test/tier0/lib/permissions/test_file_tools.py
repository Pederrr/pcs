...
from pcs.lib.permissions import file_tools
...
class ReadPcsSettingsConf(TestCase):
    ...
    def test_file_does_not_exist(self):
        ...
        facade, report_list = file_tools.read_pcs_settings_conf(self.logger)
    ...
    def test_read_success(self):
        ...
        real_facade, report_list = file_tools.read_pcs_settings_conf(
            self.logger
        )
